...
namespace EmployeeSearchProgramBrady {
    ...
    public partial class PersonnelDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(int EmployeeID, string Name, string Position, double HourlyRate) {
...
namespace EmployeeSearchProgramBrady.PersonnelDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([EmployeeID], [Name], [Position], [HourlyRate]) VAL" +
                "UES (@EmployeeID, @Name, @Position, @HourlyRate);\r\nSELECT EmployeeID, Name, Posi" +
                "tion, HourlyRate FROM Employee WHERE (EmployeeID = @EmployeeID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [EmployeeID] = @EmployeeID, [Name] = @Name, [Position] = @Position, [HourlyRate] = @HourlyRate WHERE (([EmployeeID] = @Original_EmployeeID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Position = 1 AND [Position] IS NULL) OR ([Position] = @Original_Position)) AND ((@IsNull_HourlyRate = 1 AND [HourlyRate] IS NULL) OR ([HourlyRate] = @Original_HourlyRate)));
SELECT EmployeeID, Name, Position, HourlyRate FROM Employee WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EmployeeSearchProgramBrady.Properties.Settings.Default.PersonnelConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Name, Position, HourlyRate FROM dbo.Employee";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT EmployeeID, Name, Position, HourlyRate FROM Employee WHERE Name LIKE \'%\' +" +
                " @value + \'%\'";
        ...
        public virtual int NameSearch(PersonnelDataSet.EmployeeDataTable dataTable, string value) {
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_Name, string Original_Position, global::System.Nullable<double> Original_HourlyRate) {
            ...
            if ((Original_HourlyRate.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((double)(Original_HourlyRate.Value));
            }
            else {
        ...
        public virtual int Insert(int EmployeeID, string Name, string Position, global::System.Nullable<double> HourlyRate) {
            ...
            if ((HourlyRate.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((double)(HourlyRate.Value));
            }
            else {
        ...
        public virtual int Update(int EmployeeID, string Name, string Position, global::System.Nullable<double> HourlyRate, int Original_EmployeeID, string Original_Name, string Original_Position, global::System.Nullable<double> Original_HourlyRate) {
            ...
            if ((HourlyRate.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((double)(HourlyRate.Value));
            }
            else {
            ...
            if ((Original_HourlyRate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((double)(Original_HourlyRate.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Position, global::System.Nullable<double> HourlyRate, int Original_EmployeeID, string Original_Name, string Original_Position, global::System.Nullable<double> Original_HourlyRate) {
            return this.Update(Original_EmployeeID, Name, Position, HourlyRate, Original_EmployeeID, Original_Name, Original_Position, Original_HourlyRate);
        }
    }
